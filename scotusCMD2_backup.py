...
year_search_parser = case_search_subparsers.add_parser('year',
                                                       help='year help')
year_search_parser.add_argument('-y', '--year', help='year the ruling was made')
...
class ScotusCMD(cmd2.Cmd):
    ...
    year_search_parser.set_defaults(func=search_year)
    ...
    case_search_parser2 = argparse.ArgumentParser()      
    case_search_parser2.add_argument('-y', '--year',
                                    help='year the decision was handed down')
    
    @cmd2.with_argparser(case_search_parser2)
